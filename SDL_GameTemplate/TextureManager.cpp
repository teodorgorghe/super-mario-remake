...
TextureManager::TextureManager(SDL_Renderer* renderer, Theme::Id theme) : renderer{ renderer } {
    ...
    //flower mario
    textures.insert_or_assign(FLOWER_MARIO_STAND, new SDL_Rect{0, 354, TILE_SIZE, TILE_SIZE * 2 });
    textures.insert_or_assign(FLOWER_MARIO_RUN_1, new SDL_Rect{17, 354, TILE_SIZE, TILE_SIZE * 2 });
    textures.insert_or_assign(FLOWER_MARIO_RUN_2, new SDL_Rect{34, 354, TILE_SIZE, TILE_SIZE * 2 });
    textures.insert_or_assign(FLOWER_MARIO_RUN_3, new SDL_Rect{51, 354, TILE_SIZE, TILE_SIZE * 2 });
    textures.insert_or_assign(FLOWER_MARIO_JUMP, new SDL_Rect{85, 354, TILE_SIZE, TILE_SIZE * 2 });
    textures.insert_or_assign(FLOWER_MARIO_DRIFT, new SDL_Rect{68, 354, TILE_SIZE, TILE_SIZE * 2 });
    textures.insert_or_assign(FLOWER_MARIO_DUCK, new SDL_Rect{102, 354, TILE_SIZE, TILE_SIZE * 2 });
    textures.insert_or_assign(FLOWER_MARIO_GROW, new SDL_Rect{119, 354, TILE_SIZE, TILE_SIZE * 2 });
    textures.insert_or_assign(FIRING_MARIO, new SDL_Rect{136, 354, TILE_SIZE, TILE_SIZE * 2 });

    //tiles

    textures.insert_or_assign(MUSHROOM, new SDL_Rect{119, 204, TILE_SIZE, TILE_SIZE});
    textures.insert_or_assign(FLOWER, new SDL_Rect{170, 254, TILE_SIZE, TILE_SIZE });
    ...
    {
    case Theme::CASTLE:
        textures.insert_or_assign(FLOOR, new SDL_Rect{ 85, 17, TILE_SIZE, TILE_SIZE });
        textures.insert_or_assign(BLOCK, new SDL_Rect{ 136, 34, TILE_SIZE, TILE_SIZE });
        textures.insert_or_assign(BRICK, new SDL_Rect{ 170, 17, TILE_SIZE, TILE_SIZE });
        textures.insert_or_assign(GOOMBA, new SDL_Rect{ 51, 187, TILE_SIZE, TILE_SIZE });
        textures.insert_or_assign(GOOMBA_CRUSHED, new SDL_Rect{ 34, 187, TILE_SIZE, TILE_SIZE });
        break;
    case Theme::UNDERGROWND:
        textures.insert_or_assign(FLOOR, new SDL_Rect{ 85, 34, TILE_SIZE, TILE_SIZE });
        textures.insert_or_assign(BLOCK, new SDL_Rect{ 85, 51, TILE_SIZE, TILE_SIZE });
        textures.insert_or_assign(BRICK, new SDL_Rect{ 68, 34, TILE_SIZE, TILE_SIZE });
        textures.insert_or_assign(GOOMBA, new SDL_Rect{ 85, 187, TILE_SIZE, TILE_SIZE });
        textures.insert_or_assign(GOOMBA_CRUSHED, new SDL_Rect{ 68, 187, TILE_SIZE, TILE_SIZE });
        break;
    default:
    ...
    textures.insert_or_assign(SUPER_MARIO_FLAG_1, new SDL_Rect{ 0, 271, TILE_SIZE, TILE_SIZE * 2});
    textures.insert_or_assign(SUPER_MARIO_FLAG_2, new SDL_Rect{ 17, 271, TILE_SIZE, TILE_SIZE * 2 });
    textures.insert_or_assign(FLOWER_MARIO_FLAG_1, new SDL_Rect{ 0, 387, TILE_SIZE, TILE_SIZE * 2 });
    textures.insert_or_assign(FLOWER_MARIO_FLAG_2, new SDL_Rect{ 17, 387, TILE_SIZE, TILE_SIZE * 2 });

    textures.insert_or_assign(FIREBALL_1, new SDL_Rect{85, 321, TILE_SIZE / 2, TILE_SIZE / 2 });
    textures.insert_or_assign(FIREBALL_2, new SDL_Rect{94, 321, TILE_SIZE / 2, TILE_SIZE / 2 });
    textures.insert_or_assign(FIREBALL_3, new SDL_Rect{103, 321, TILE_SIZE / 2, TILE_SIZE / 2 });
    textures.insert_or_assign(FIREBALL_4, new SDL_Rect{112, 321, TILE_SIZE / 2, TILE_SIZE / 2 });
    textures.insert_or_assign(EXPLOSION_1, new SDL_Rect{153, 313, TILE_SIZE, TILE_SIZE });
    textures.insert_or_assign(EXPLOSION_2, new SDL_Rect{170, 313, TILE_SIZE, TILE_SIZE });
    textures.insert_or_assign(EXPLOSION_3, new SDL_Rect{187, 313, TILE_SIZE, TILE_SIZE });

    textures.insert_or_assign(FLOWER_1, new SDL_Rect{ 136, 254, TILE_SIZE, TILE_SIZE });
    textures.insert_or_assign(FLOWER_2, new SDL_Rect{ 153, 254, TILE_SIZE, TILE_SIZE });
    textures.insert_or_assign(FLOWER_3, new SDL_Rect{ 170, 254, TILE_SIZE, TILE_SIZE });
    textures.insert_or_assign(FLOWER_4, new SDL_Rect{ 187, 254, TILE_SIZE, TILE_SIZE });

    textures.insert_or_assign(COIN_ITEM_1, new SDL_Rect{68, 204, TILE_SIZE, TILE_SIZE });
    textures.insert_or_assign(COIN_ITEM_2, new SDL_Rect{85, 204, TILE_SIZE, TILE_SIZE });
    textures.insert_or_assign(COIN_ITEM_3, new SDL_Rect{102, 204, TILE_SIZE, TILE_SIZE });

    textures.insert_or_assign(QUESTION_BLOCK_MUSHROOM, new SDL_Rect{ 153, 204, TILE_SIZE, TILE_SIZE });
    textures.insert_or_assign(QUESTION_BLOCK_COIN, new SDL_Rect{ 170, 204, TILE_SIZE, TILE_SIZE });

    textures.insert_or_assign(TUBE_HORIZONTAL_WARP_UP, new SDL_Rect{ 68, 68, TILE_SIZE, TILE_SIZE });
    textures.insert_or_assign(TUBE_HORIZONTAL_WARP_DOWN, new SDL_Rect{ 68, 85, TILE_SIZE, TILE_SIZE });
    textures.insert_or_assign(TUBE_HORIZONTAL_UP, new SDL_Rect{ 85, 68, TILE_SIZE, TILE_SIZE });
    textures.insert_or_assign(TUBE_HORIZONTAL_DOWN, new SDL_Rect{ 85, 85, TILE_SIZE, TILE_SIZE });
    textures.insert_or_assign(TUBE_INTERSECTION_UP, new SDL_Rect{ 102, 68, TILE_SIZE, TILE_SIZE });
    textures.insert_or_assign(TUBE_INTERSECTION_DOWN, new SDL_Rect{ 102, 85, TILE_SIZE, TILE_SIZE });
}

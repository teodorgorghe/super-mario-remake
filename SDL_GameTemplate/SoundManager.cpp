...
SoundManager::SoundManager() {
    ...
    sounds.insert_or_assign(Sound::Id::SUPER_JUMP, Mix_LoadWAV("assets/music/super_jump.wav"));
    ...
    sounds.insert_or_assign(Sound::Id::FIREBALL, Mix_LoadWAV("assets/music/fireball.wav"));
    ...
    sounds.insert_or_assign(Sound::Id::KICK, Mix_LoadWAV("assets/music/kick.wav"));
    ...
    sounds.insert_or_assign(Sound::Id::BUMP, Mix_LoadWAV("assets/music/bump.wav"));
    sounds.insert_or_assign(Sound::Id::PIPE, Mix_LoadWAV("assets/music/pipe.wav"));

    musics.insert_or_assign(Music::Id::BACKGROUND, Mix_LoadMUS("assets/music/overworld.wav"));
    musics.insert_or_assign(Music::Id::UNDERGROUND, Mix_LoadMUS("assets/music/underground.wav"));
    musics.insert_or_assign(Music::Id::CASTLE, Mix_LoadMUS("assets/music/castle.ogg"));
